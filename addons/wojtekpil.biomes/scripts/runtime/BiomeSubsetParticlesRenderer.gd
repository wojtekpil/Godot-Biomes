...
var ParticlePlacementShader = preload("res://addons/wojtekpil.biomes/shaders/particle_placer.shader")
var ParticlePlacementShaderGPU = preload("res://addons/wojtekpil.biomes/shaders/particle_placer_gpu.shader")
